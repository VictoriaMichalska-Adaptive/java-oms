import weareadaptive.com.cluster.services.oms.OrderbookImpl;
...
public class OrderbookTest {
    ...
    public void placeRestingBid() {
        ...
        assertEquals(Status.RESTING, returnedBid.getStatus());
    }
    ...
    public void multipleIdenticalBids() {
        ...
        assertEquals(Status.FILLED, completedAsk.getStatus());
        ...
        assertEquals(firstBid.getOrderId(), cancelledBid.getOrderId());

        // assert other bids were cancelled and therefore not fulfilled
        assertEquals(Status.CANCELLED, cancelledSecondBid.getStatus());
        assertEquals(secondBid.getOrderId(), cancelledSecondBid.getOrderId());
        assertEquals(Status.CANCELLED, cancelledThirdBid.getStatus());
        assertEquals(thirdBid.getOrderId(), cancelledThirdBid.getOrderId());
    }
